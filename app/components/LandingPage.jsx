  ...
  render() {
    return (
      <div className="container" >
        <h4 className="text-center" style={{ fontWeight: 'bold' }}>Coming up</h4>
        <ComingUpCarousel />
        <BlockHeader text="Mind these:" />
        <div className="row">
          <div className="col-sm-6 col-xs-12" style={{ padding: '10px' }}>
            <button type="button" className="btn-lg btn-primary col-xs-12">View feedback</button>
          </div>
          <div className="col-sm-6 col-xs-12" style={{ padding: '10px' }}>
            <button type="button" className="btn-lg btn-primary col-xs-12">View Coaches</button>
          </div>
        </div>
